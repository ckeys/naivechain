...
public class HTTPService {
    ...
    public void initHTTPServer(int port) {
        try {
            ...
            System.out.println(context.getServletHandler().getServletContext());
            server.start();
            server.join();
        } catch (Exception e) {
...
//            peer = "ws://localhost:7001";
    ...
    private class PeersServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            resp.setCharacterEncoding("UTF-8");
            System.out.println(p2pService.getSockets().size());
            ...
            resp.getWriter().print("ws:10.10.10.1:8081");
        }
    }
